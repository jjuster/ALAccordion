...
// ALAccordion
#define COCOAPODS_POD_AVAILABLE_ALAccordion
#define COCOAPODS_VERSION_MAJOR_ALAccordion 0
#define COCOAPODS_VERSION_MINOR_ALAccordion 1
#define COCOAPODS_VERSION_PATCH_ALAccordion 0
