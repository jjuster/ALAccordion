...
public class AccordionViewController: UIViewController
{
    ...
    private var sections = [AccordionSectionViewController]()
    ...
    public func setSections(sections: AccordionSectionViewController...)
    {
        for s in sections
        {
            s.accordion = self
    ...
    func setupFooterView(footer: UIView)
    {
    ...
    func openSection(section: AccordionSectionViewController, animated: Bool)
    {
    ...
    func closeSection(section: AccordionSectionViewController, animated: Bool)
    {
